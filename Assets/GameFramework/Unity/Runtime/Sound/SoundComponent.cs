...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class SoundComponent : GameFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            {
                LogUtil.Fatal("Sound manager is invalid.");
                return;
            }
        ...
        private void Start()
        {
            ...
            if (soundHelper == null)
            {
                LogUtil.Error("Can not create sound helper.");
                return;
            }
            ...
            for (int i = 0; i < m_SoundGroups.Length; i++)
            {
                ...
                {
                    LogUtil.Warning("Add sound group '{0}' failure.", m_SoundGroups[i].Name);
                    continue;
                }
            }
        }
        ...
        public bool AddSoundGroup(string soundGroupName, bool soundGroupAvoidBeingReplacedBySamePriority, bool soundGroupMute, float soundGroupVolume, int soundAgentHelperCount)
        {
            ...
            {
                LogUtil.Error("Can not create sound group helper.");
                return false;
            }
        ...
        private bool AddSoundAgentHelper(string soundGroupName, SoundGroupHelperBase soundGroupHelper, int index)
        {
            ...
            {
                LogUtil.Error("Can not create sound agent helper.");
                return false;
            }
