...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class WebRequestComponent : GameFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            {
                LogUtil.Fatal("Web request manager is invalid.");
                return;
            }
        ...
        private void AddWebRequestAgentHelper(int index)
        {
            ...
            {
                LogUtil.Error("Can not create web request agent helper.");
                return;
            }
        ...
        {
            LogUtil.Warning("Web request failure, web request serial id '{0}', web request uri '{1}', error message '{2}'.", e.SerialId, e.WebRequestUri, e.ErrorMessage);
